    ...
    for (const row of flaggedData) {
      ...
      const result = await pool.query(
        `INSERT INTO partner_details (
          ...
          partner_status_id, req_status, req_status_id, temp_add, temp_zip_code, perm_add, perm_zip_code, tbs_user_id
        ) 
        ...
        [
          ...
          req_status, req_status_id, temp_add, temp_zip_code, perm_add, perm_zip_code, tbs_user_id
        ]
      );
