...
reqrouter.get('/request-offerStatus/:tbs_user_id/:req_status_id', getOffersDealsByStatus);
...
reqrouter.get('/request-DiscountofferStatus/:tbs_user_id/:req_status_id', getDiscountOffersDealsByStatus);
