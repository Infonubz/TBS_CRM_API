...
reqrouter.get('/request-adStatus/:req_status_id', getAdvertisementsByStatus);
...
reqrouter.get('/request-mobile-adStatus/:req_status_id', getMobileAdvertisementsByStatus);
