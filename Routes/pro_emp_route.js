...
const { createEMPpro, updateEMPpro, deleteEMPpro, getEMPpro, getEMPByIDpro, getAllEMPpro, emailValidationpro, Phonevalidationspro, employeeLoginpro, getAllEmployeespro, getEmployeeByIdpro, updateEmployeeDetailspro, putEmployeepro, createDetailspro, fetchdataByIdpro, fetchdatapro, AddEmpDocpro, FetchDocpro, FetchAllDocspro, FetchDoconlypro, FetchAllDocsOnlypro, searchEmployeespro, insertDatapro, updateEMPStatusPro, GETProfilepro, GETAllProfilepro, getEmails, getPhones, getAllProEMPbyOwnerid } = require('../Controller/pro_emp_controller');
...
proemprouter.get('/pro-All-emp-details/:owner_id', getAllProEMPbyOwnerid)
