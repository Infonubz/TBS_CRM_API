...
patrouter.post('/partner_details', createPartner)
patrouter.put('/partner_details_update/:tbs_partner_id', updatePartner)
...
patrouter.post('/partner_phone-validation')
...
{ name: 'other_documents', maxCount: 1 }]),AddPartnerDoc)
...
patrouter.put('/partner_profileImg/:tbs_partner_id', partner_upload.single('profile_img'), updatePartnerProfile)
