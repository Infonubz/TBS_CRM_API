...
const { themeRouter } = require('./Routes/themes_routes');
const { liveRoute } = require('./Routes/Live_discount_and_promotion');
...
app.use('/theme_files', express.static('theme_files'));
